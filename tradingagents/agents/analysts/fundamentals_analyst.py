    ...
    def fundamentals_analyst_node(state):
        ...
        system_message = (
                ...
                + "  DCF PLAUSIBILITY CHECK: before citing a DCF fair value as evidence of over/undervaluation,"
                  ...
                  " deteriorating economics). When the DCF implies a margin of safety beyond roughly +/-75% AND the"
                  " analyst consensus or quality screens point the opposite direction, say so explicitly — state that"
                  " the DCF diverges sharply from consensus/quality signals and may reflect a modeling limitation rather"
                  " than a genuine valuation signal — instead of treating it as an equally-weighted value screen"
                  " alongside FCF yield, EY, and the multiples (MSFT 2026-09-10/09-16: DCF fair value ~$110-113 implied"
                  " -77% to -79% margin of safety against a $490 price, while 32 analysts carried a BUY consensus with a"
                  " mean target near $573 and the same report scored Altman Z 8.0/safe and LOW trap risk — the DCF"
                  " reduced almost exactly to FCF-per-share / (WACC - g), a bare current-FCF perpetuity, and should have"
                  " been flagged as basis-mismatched with the rest of the evidence rather than cited as a coequal fail)."
