...
- get_market_breadth(...) - the market-WIDE breadth read (percent above the 20/50/200-day, advance-decline, new highs/lows) over the index panel, with its panel size printed. Use it before any 'breadth is narrowing / broadening / the rally is thinning' claim - a single name cannot show market breadth.
