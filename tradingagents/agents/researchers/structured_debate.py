...
def build_turn_prompt(state: dict, role: str, stance: str) -> str:
    ...
    head = [
        ...
        "",
        "**Example output (shape only, values illustrative — the stance value is YOUR role):**",
        f'{{ "round_index": 1, "stance": "{stance}", "core_thesis": "Margin compression in 2H; DCF below price.", "quantitative_claims": [ {{ "metric_name": "Forward P/E", "asserted_value": 18.7, "ground_truth_key": "pe_ttm", "source": "analyst_report" }} ], "risk_factors": [ {{ "risk_id": "margin_compression", "severity": "high", "mitigation_stated": true }} ], "recommended_allocation_pct": 2.0 }}',
        "",
        "",
        "---",
