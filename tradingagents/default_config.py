...
_ENV_OVERRIDES = {
    ...
    "TRADINGAGENTS_ENABLE_HARD_GUARDS": "enable_hard_guards",
    "TRADINGAGENTS_ALPHA_LEDGER_ENABLE": "alpha_ledger_enable",
    ...
    "TRADINGAGENTS_ENABLE_ACCURACY_CEILING": "enable_accuracy_ceiling",
    ...
    "TRADINGAGENTS_ENABLE_FORWARD_STRESS_PROBABILITY": "enable_forward_stress_probability",
    "TRADINGAGENTS_ENABLE_PROMPT_CONDITION_HARNESS": "enable_prompt_condition_harness",
...
DEFAULT_CONFIG = _apply_env_overrides(
    {
        ...
        # Moomoo US value-dip screener (Stock Screening V2). Off by default;
        ...
        "enable_hard_guards": False,  # hard guards feed the execution multiplier
        "alpha_ledger_enable": False,  # append alpha-ledger rows per run (default off)
        ...
        "enable_forward_stress_probability": False,
        "enable_prompt_condition_harness": False,
