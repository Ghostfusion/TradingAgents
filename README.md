...
- [2026-08-20] **Agent decision-tools audit (plan)** - `docs/developer/11-agent-decision-tools.md` audits all strategy/dataflow functions and lists which decision-critical ones are not yet exposed as `@tool`s (exits, allocation, regime components, momentum detail, consensus, event multipliers), with a P0/P1/P2 integration order. No code changed yet.
