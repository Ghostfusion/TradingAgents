...
## News
- [2026-09-05] **Quant-engine v2** - DuPont ROE decomposition (`get_dupont_read`), scenario DCF (`get_scenario_dcf`), and an earnings-quality verdict (`get_earnings_quality_verdict`) — all advisory, from the 69-section quant spec (`docs/design_quant_engine_v2.md`). See CHANGELOG.
