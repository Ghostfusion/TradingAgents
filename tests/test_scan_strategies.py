...
def _patch_network():
    with mock.patch.object(vs, "route_to_vendor", side_effect=_fixture_route),          mock.patch("tradingagents.dataflows.moomoo.get_top_movers_moomoo",
...
def _breakout_route(method, *a, **k):
    if method == "get_stock_data":
        ...
        for i in range(240):
            ...
            rows.append(f"2026-01-{i%28+1:02d},{price:.2f},{price+3:.2f},{price-3:.2f},{price:.2f},{vol}")
        return "\n".join(rows) + "\n"
