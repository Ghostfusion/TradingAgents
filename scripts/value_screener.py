        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    _dn = _don(_hi, _lo, closes=_cl)
                    row["donch_up"] = _dn.get("upper")
                    row["donch_lo"] = _dn.get("lower")
                    row["donch_breakout_up"] = _dn.get("breakout_up")
                    row["donch_breakout_dn"] = _dn.get("breakout_dn")
                    _ov = _obv(_cl, _vl)
                    row["obv_up"] = _ov.get("obv_up")
                    _ps = _psar(_hi, _lo, closes=_cl)
                    row["psar"] = _ps.get("sar")
                    row["psar_below"] = _ps.get("below")
