...
- **Prompt budget.** The market prompt measures **41,999** chars (the new rules' prose), over the 40,300 ceiling, so `test_prompt_budget_contract.MARKET_CEILING` is raised to **42,050** with the measured reason and a 51-char slack in the same comment; the other two prompts stay under it (fundamentals 27,617 / news 13,160). Bullet count 79/95, unchanged.
