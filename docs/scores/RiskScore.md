...
3. **Should `net_beta` be implemented or deleted?** §3.3 shows it is neither
   produced nor read. Implementing it needs a per-name beta (`etf_risk._beta:38`
