...
| --- | --- | --- | --- |
| Strategy calculators | `test_strategies_*.py` | 23 | every `strategies/*` pure function (incl. `test_strategies_value_dip.py` for the Value Dip + Swing hybrid + tranche risk fold) |
