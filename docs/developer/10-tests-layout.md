...
| --- | --- | --- | --- |
| Strategy calculators | `test_strategies_*.py` | 26 | every `strategies/*` pure function (incl. `test_strategies_value_dip.py`, `test_strategies_pre_market.py`, `test_strategies_ratios.py`, `test_strategies_market_session.py`) |
